...
//    [an mobileDeviceLoginRequest: mobileDeviceLoginRequest];
    ...
    mobileDeviceRegistrationRequest.anetApiRequest.merchantAuthentication.name = @"jovhenni19";
    mobileDeviceRegistrationRequest.anetApiRequest.merchantAuthentication.password = @"Vhengshua19";
