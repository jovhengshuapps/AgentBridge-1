...
- (void) setupSimpleCPRequest:(CreateTransactionRequest *)request;
- (NSString *) doMobileRegistrationAndLoginToGetSessionToken;
- (NSString *) doMobileRegistrationAndLoginToGetCPSessionToken;
@end
...
- (void) setupSimpleCPRequest:(CreateTransactionRequest *)request
{
    NSString *sessionToken = [self doMobileRegistrationAndLoginToGetCPSessionToken];
    request.anetApiRequest.merchantAuthentication.sessionToken = sessionToken;
    request.anetApiRequest.merchantAuthentication.mobileDeviceId = MOBILE_DEVICE_ID;
}
...
- (void) setupCPMobileDeviceLoginRequest:(MobileDeviceLoginRequest *) request 
{
	request.anetApiRequest.merchantAuthentication.name = CPUSERNAME;
	request.anetApiRequest.merchantAuthentication.password = CPPASSWORD;
...
- (NSString *) doMobileRegistrationAndLoginToGetCPSessionToken {
    ...
    NSLog(@"Registration successful.  Message = %@", m);
    MobileDeviceLoginRequest *loginRequest = [MobileDeviceLoginRequest mobileDeviceLoginRequest];
    [self setupCPMobileDeviceLoginRequest:loginRequest];
...
- (void) testCardPresentAuthNetPurchaseWithTrack1And2
{
	CreateTransactionRequest *request = [CreateTransactionRequest createTransactionRequest];
	[self setupSimpleCPRequest:request];
    
    request.transactionRequest.retail.marketType = MARKET_TYPE_RETAIL;
    request.transactionRequest.retail.deviceType = DEVICE_TYPE_WIRELESS_POS;
    request.transactionRequest.payment.trackData.track1 = @"%B4111111111111111^CARDUSER/JOHN^1803101000000000020000831000000?";
    request.transactionRequest.payment.trackData.track2 = @";4111111111111111=1803101020831?";
	request.transactionRequest.amount = @"4.33";
    AuthNet *an = [AuthNet getInstance];
	an.duplicateWindowValue = 1;
    ...
    request.anetApiRequest.merchantAuthentication.sessionToken = ((CreateTransactionResponse *)an.response).sessionToken;
	//Slowly add to the request.  This simple request has Shipping Charges included
	request.transactionRequest.amount = @"12.11";
	request.transactionRequest.shipping = [ExtendedAmountType extendedAmountType];
	request.transactionRequest.shipping.amount = @"0.15";
	request.transactionRequest.shipping.name = @"my_tax";
	request.transactionRequest.shipping.amountDescription = @"my_tax_description";
...
- (void) testCardPresentAuthNetPurchaseWithTrack1
{
	CreateTransactionRequest *request = [CreateTransactionRequest createTransactionRequest];
	[self setupSimpleCPRequest:request];
    ...
    request.transactionRequest.retail.deviceType = DEVICE_TYPE_WIRELESS_POS;
    request.transactionRequest.payment.trackData.track1 = @"%B4111111111111111^CARDUSER/JOHN^1803101000000000020000831000000?";
    request.transactionRequest.payment.trackData.track2 = @"";
	request.transactionRequest.amount = @"53.33";
    AuthNet *an = [AuthNet getInstance];
	an.duplicateWindowValue = 1;
    ...
    request.anetApiRequest.merchantAuthentication.sessionToken = ((CreateTransactionResponse *)an.response).sessionToken;
	//Slowly add to the request.  This simple request has Shipping Charges included
	request.transactionRequest.amount = @"21.11";
	request.transactionRequest.shipping = [ExtendedAmountType extendedAmountType];
	request.transactionRequest.shipping.amount = @"0.15";
	request.transactionRequest.shipping.name = @"my_tax";
	request.transactionRequest.shipping.amountDescription = @"my_tax_description";
...
- (void) testCardPresentAuthNetPurchaseWithTrack2
{
	CreateTransactionRequest *request = [CreateTransactionRequest createTransactionRequest];
	[self setupSimpleCPRequest:request];
    ...
    request.transactionRequest.retail.marketType = MARKET_TYPE_RETAIL;
    request.transactionRequest.retail.deviceType = DEVICE_TYPE_WIRELESS_POS;
    request.transactionRequest.payment.trackData.track1 = @"";
    request.transactionRequest.payment.trackData.track2 = @";4111111111111111=1803101020831?";
	request.transactionRequest.amount = @"33.33";
    AuthNet *an = [AuthNet getInstance];
	an.duplicateWindowValue = 1;
    ...
    request.anetApiRequest.merchantAuthentication.sessionToken = ((CreateTransactionResponse *)an.response).sessionToken;
	//Slowly add to the request.  This simple request has Shipping Charges included
	request.transactionRequest.amount = @"151.11";
	request.transactionRequest.shipping = [ExtendedAmountType extendedAmountType];
	request.transactionRequest.shipping.amount = @"0.15";
	request.transactionRequest.shipping.name = @"my_tax";
	request.transactionRequest.shipping.amountDescription = @"my_tax_description";
