...
@property (nonatomic, retain) UIViewController *loginVC;
@property (nonatomic, retain) UIViewController *checkoutVC;
...
- (void) makeRequest:(AuthNetRequest *) r {
	...
	[self issueSSLPost:XMLAIMRequest withURL:requestUrl];
}
...
- (BOOL) issueSSLPost:(NSString *)body withURL:(NSString *)url {
    ...
    NSLog(@"request sent pending response");
